...
echo '<br>' . "Задание 2, слайд 21 первый вариант (цикл while)" . '<br>';
$num=1000;
$a = 50;
$i = 0;
while ($num > $a) {
...
//Втророй вариант
echo '<br>' . "Задание 2, слайд 21 второй вариант (цикл for)" . '<br>';
$n = 1000;
$j = 0;
for ($n=1000; $n > 50; $n / 2) {
    $n = $n / 2;
